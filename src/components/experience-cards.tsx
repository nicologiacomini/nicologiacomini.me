...
export function ExperienceCard({ company, position, dates, description, linkCompany, img }: ExperienceCardProps) {
  return (
    ...
    <a href={linkCompany} className="group relative block h-16 w-16 overflow-hidden rounded-lg">
        ...
        <div className="col-span-11 flex flex-col pr-8 text-left sm:pl-4 pb-2">
            <a href={linkCompany} className="inline-block w-fit overflow-hidden text-text-button text-lg font-[Onest-Bold] sm:text-xl">{company}</a>
