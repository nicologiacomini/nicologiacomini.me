    ...
    return (
      <div>
        ...
        <div className="flex justify-between items-center mx-5 py-3">
          <div className="group relative h-6 w-6 rounded-lg mr-4">
            <TiRss className="h-6 w-6 object-cover" />
          </div>
          <div className="font-[Onest-Light] text-sm">
            Don't miss anything, save the RSS feed!
          </div>
        </div>
        </a>
